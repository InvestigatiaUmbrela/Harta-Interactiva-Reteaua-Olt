...
const MEMBERS = {
  ...
  covaciu:       { img: ["Covaciu", "SRI WHITE 6"], txt: ["Vasile COVACIU", ["Director", 846, 1293]],
                   sec: { kind: "company-state", txt: [["C.A.O.", 835, 1349]] } },
  usurelu:       { img: ["Usurelu", "PSD WHITE 11"], txt: ["Cătălin UȘURELU", ["Director", 374, 1290]],
                   sec: { kind: "company-state", txt: [["C.A.O.", 365, 1346]] } },
